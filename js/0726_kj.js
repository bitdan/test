jQuery(document).ready(function () {
    ...
    function setjfadd(xuh) {
        ...
        for (var index = 0; index <= xuh; index++) {
            ...
            var isvalid = jQuery("#field23964_" + index).val() != "" && jQuery("#disfield23971_" + index).val() != "";
            //扣款事由和扣款金额不为空时添加一行
            if (isvalid) {
                ...
                var Deductionmoney = jQuery("#field23964_" + index).val(); //扣款金额 field23964
                ...
                //alert(fymxbmid);
                var Deduction = jQuery("#disfield23971_" + index).val(); //扣款事由  disfield23971
                var Deductiontext = jQuery("#disfield23971_" + index + "  option:selected").text(); //扣款事由 disfield23971
    ...
    function setjfaddInputtax(xuh) {
        jQuery("#field16276_" + xuh).val("40"); //记账码
        jQuery("#field16276_" + xuh + "span").text("40");

        jQuery("#field16277_" + xuh).val("WITHHOLDING TAX"); //文本
        jQuery("#field16277_" + xuh + "span").text("");

        jQuery("#field16280_" + xuh).val(0); //金额
        jQuery("#field16280_" + xuh + "span").text("");

        jQuery("#field16278_" + xuh).val("2221210100"); //科目编号编号
        jQuery("#field16278_" + xuh + "span").text("2221210100");

        jQuery("#field16279_" + xuh).val("应交税费_代扣代缴税_供应商N"); //科目名称
        jQuery("#field16279_" + xuh + "span").text("");
    }

    function setdfaddInputtax(xuh) {
        jQuery("#field16266_" + xuh).val("50"); //记账码
        jQuery("#field16266_" + xuh + "span").text("50");

        jQuery("#field16285_" + xuh).val("WITHHOLDING TAX"); //文本
        jQuery("#field16285_" + xuh + "span").text("");

        jQuery("#field16286_" + xuh).val(0); //金额
        jQuery("#field16286_" + xuh + "span").text("");

        jQuery("#field16274_" + xuh).val("2221210100"); //科目编号编号
        jQuery("#field16274_" + xuh + "span").text("2221210100");

        jQuery("#field16288_" + xuh).val("应交税费_代扣代缴税_供应商N"); //科目名称
        jQuery("#field16288_" + xuh + "span").text("");
    }
    ...
    var indexnum0fina0 = 0;
    var indexnum0fina1 = 0;
    var indexnum0fina2 = 0;
    if (document.getElementById("indexnum0")) {
        indexnum0fina0 = document.getElementById("indexnum0").value * 1.0 - 1;
        indexnum0final = document.getElementById("indexnum1").value * 1.0;
        indexnum0fina2 = document.getElementById("indexnum2").value * 1.0;
    }
    setjfadd(indexnum0fina0);

    if (indexnum0fina2 < 2) {
        var _sdbehalf = f_sdbehalf;
        _sdbehalf = jQuery("#" + _sdbehalf).val();
        if (_sdbehalf != "") {
            addRow2(2);
            if (_sdbehalf == "0") {
                window.flag = true;
